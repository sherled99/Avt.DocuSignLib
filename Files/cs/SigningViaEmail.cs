namespace Avt.DocuSignLib.Files.cs
{
    ...
    public static class SigningViaEmail
    {
        ...
        public static string SendEnvelopeViaEmail(string signerEmail, string signerName, string ccEmail, string ccName, string accessToken, string basePath, string accountId, Byte [] docDocx, Byte[] docPdf, string envStatus)
        {
            // Step 1 start
        ...
        public static EnvelopeDefinition MakeEnvelope(string signerEmail, string signerName, string ccEmail, string ccName, Byte[] docDocx, Byte[] docPdf, string envStatus)
        {
            ...
            // Step 2 start
            string doc2DocxBytes = Convert.ToBase64String(docDocx);
            string doc3PdfBytes = Convert.ToBase64String(docPdf);
            // Step 2 end
